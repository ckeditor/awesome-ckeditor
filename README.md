...
- [Plotly.js](https://github.com/Simply007/ckeditor5-plotly-widget-showcase) - Plotly.js chart library demo persiting data in the editor content and rendroing charts as a widget.
